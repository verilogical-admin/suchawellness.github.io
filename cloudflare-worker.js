...
- [Sucha Skill Lab](https://www.suchawellness.com/skill-lab): Premium practice hub for Self-Esteem Lab, Patience Gym, Focus Lab, Second Brain Lab, Mental Models Lab, Crucial Conversations Lab, Trigger Response Lab, Safe Space Lab, Sales EQ Lab, Difficult People Lab, Business Drama Lab, Collaboration Lab, Negotiation Lab, Psychopath Mask Lab, Persuasion Lab, Human Nature Lab, Courage Lab, Power Literacy Lab, Communication Colors Lab, Manipulation Protection Lab, Narcissism Boundaries Lab, Self-Sabotage Lab, and Influence Science Lab. Included with Empathy + EQ Labs Premium, not sold as a separate module.
...
- [Focus Lab](https://www.suchawellness.com/focus-training): Sucha skill lab inspired by Indistractable for mastering internal triggers, timeboxing traction, hacking back distraction, and setting attention pacts. Included with Empathy + EQ Labs Premium.
- [Second Brain Lab](https://www.suchawellness.com/second-brain-training): Sucha skill lab inspired by Building a Second Brain for CODE, PARA, note distillation, and useful output. Included with Empathy + EQ Labs Premium.
- [Mental Models Lab](https://www.suchawellness.com/mental-models-training): Sucha skill lab for inversion, second-order thinking, opportunity cost, probability, systems, and decision practice. Included with Empathy + EQ Labs Premium.
- [Crucial Conversations Lab](https://www.suchawellness.com/crucial-conversations-training): Sucha skill lab inspired by Crucial Conversations for safety, story-checking, STATE openers, listening tools, and clear agreements. Included with Empathy + EQ Labs Premium.
- [Trigger Response Lab](https://www.suchawellness.com/trigger-response-training): Sucha skill lab for recognizing emotional activation, body cues, trigger stories, regulation moves, response choice, boundaries, and repair after getting triggered. Included with Empathy + EQ Labs Premium.
- [Safe Space Lab](https://www.suchawellness.com/safe-space-training): Sucha skill lab for creating emotional safety through presence, consent, validation, boundaries, non-shaming language, conversation containers, and repair. Included with Empathy + EQ Labs Premium.
...
- [Business Drama Lab](https://www.suchawellness.com/business-drama-training): Sucha skill lab for handling reactive clients, gossip, guilt pressure, blame loops, urgent emotions, respectful boundaries, documentation, and professional scripts in business. Included with Empathy + EQ Labs Premium.
...
- [Negotiation Lab](https://www.suchawellness.com/negotiation-training): Sucha skill lab inspired by Never Split the Difference for practicing tactical empathy, mirroring, labels, no-oriented asks, calibrated questions, execution checks, and hidden-information discovery. Included with Empathy + EQ Labs Premium.
- [Psychopath Mask Lab](https://www.suchawellness.com/psychopath-mask-training): Sucha skill lab inspired by Talking with Psychopaths for recognizing charm masks, deception, no-remorse behavior, conversation traps, evidence practices, and safety-minded exit planning. Included with Empathy + EQ Labs Premium.
- [Persuasion Lab](https://www.suchawellness.com/persuasion-training): Sucha skill lab inspired by Bob Burg's The Art of Persuasion for ethical influence, value creation, gentle choices, resistance handling, repair scripts, and persuasive ask practice. Included with Empathy + EQ Labs Premium.
- [Human Nature Lab](https://www.suchawellness.com/human-nature-training): Sucha skill lab inspired by Robert Greene's The Laws of Human Nature for reading emotion, masks, envy, grandiosity, conformity, self-control, and purpose. Included with Empathy + EQ Labs Premium.
- [Courage Lab](https://www.suchawellness.com/courage-disliked-training): Sucha skill lab inspired by The Courage to Be Disliked for task separation, approval detox, courage reps, contribution, and self-directed living. Included with Empathy + EQ Labs Premium.
- [Power Literacy Lab](https://www.suchawellness.com/power-literacy-training): Sucha skill lab for ethical power literacy practice: status moves, leverage, documentation, pressure delays, and clean counters. Included with Empathy + EQ Labs Premium.
- [Communication Colors Lab](https://www.suchawellness.com/communication-colors-training): Sucha skill lab for adapting communication across direct, expressive, steady, and analytical styles. Included with Empathy + EQ Labs Premium.
- [Manipulation Protection Lab](https://www.suchawellness.com/psychopath-protection-training): Sucha skill lab for charm-pressure recognition, vulnerability protection, documentation, and safe exits. Included with Empathy + EQ Labs Premium.
- [Narcissism Boundaries Lab](https://www.suchawellness.com/narcissist-boundaries-training): Sucha skill lab for entitlement recognition, concise limits, access boundaries, and energy recovery. Included with Empathy + EQ Labs Premium.
- [Self-Sabotage Lab](https://www.suchawellness.com/self-sabotage-training): Sucha skill lab for identifying protective patterns, hidden needs, body regulation, and tiny aligned action. Included with Empathy + EQ Labs Premium.
- [Influence Science Lab](https://www.suchawellness.com/influence-science-training): Sucha skill lab for ethical reciprocity, honest proof, authority, consistency, scarcity, unity, and clean choice. Included with Empathy + EQ Labs Premium.
...
- [Empathy + EQ Labs Premium](https://www.suchawellness.com/empathy-lab): Shared $10,000/year premium lab access for empathy, emotional intelligence, Self-Esteem Lab, Patience Gym, Focus Lab, Second Brain Lab, Mental Models Lab, Crucial Conversations Lab, Trigger Response Lab, Safe Space Lab, Sales EQ Lab, Difficult People Lab, Business Drama Lab, Collaboration Lab, Negotiation Lab, Psychopath Mask Lab, Persuasion Lab, Human Nature Lab, Courage Lab, Power Literacy Lab, Communication Colors Lab, Manipulation Protection Lab, Narcissism Boundaries Lab, Self-Sabotage Lab, and Influence Science Lab practice, currently unlockable through dedicated Empathy Lab coupons or Razorpay checkout.
- [Sucha skill labs](https://www.suchawellness.com/skill-lab): Practice-based personal growth modules, including Self-Esteem Lab, Patience Gym, Focus Lab, Second Brain Lab, Mental Models Lab, Crucial Conversations Lab, Trigger Response Lab, Safe Space Lab, Sales EQ Lab, Difficult People Lab, Business Drama Lab, Collaboration Lab, Negotiation Lab, Psychopath Mask Lab, Persuasion Lab, Human Nature Lab, Courage Lab, Power Literacy Lab, Communication Colors Lab, Manipulation Protection Lab, Narcissism Boundaries Lab, Self-Sabotage Lab, and Influence Science Lab, included with the shared Empathy + EQ Labs Premium bundle.
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    <loc>https://www.suchawellness.com/skill-lab</loc>
  ...
  <url>
    <loc>https://www.suchawellness.com/focus-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/second-brain-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/mental-models-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/crucial-conversations-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/trigger-response-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/safe-space-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/sales-training</loc>
    <lastmod>2026-08-24</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  ...
  <url>
    <loc>https://www.suchawellness.com/business-drama-training</loc>
  ...
  <url>
    <loc>https://www.suchawellness.com/negotiation-training</loc>
    <lastmod>2026-08-26</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/psychopath-mask-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/persuasion-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/human-nature-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/courage-disliked-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/power-literacy-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/communication-colors-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/psychopath-protection-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/narcissist-boundaries-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/self-sabotage-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://www.suchawellness.com/influence-science-training</loc>
    <lastmod>2026-08-27</lastmod>
    <changefreq>weekly</changefreq>
    <priority>0.9</priority>
  </url>
...
export default {
  async fetch(request, env) {
    ...
    const cleanPageMap = {
      ...
      '/tests': '/tests.html',
      '/skill-lab': '/skill-lab.html',
      '/self-esteem-training': '/self-esteem-training.html',
      '/patience-training': '/patience-training.html',
      '/focus-training': '/focus-training.html',
      '/second-brain-training': '/second-brain-training.html',
      '/mental-models-training': '/mental-models-training.html',
      '/crucial-conversations-training': '/crucial-conversations-training.html',
      '/trigger-response-training': '/trigger-response-training.html',
      '/safe-space-training': '/safe-space-training.html',
      '/sales-training': '/sales-training.html',
      '/difficult-people-training': '/difficult-people-training.html',
      '/business-drama-training': '/business-drama-training.html',
      '/collaboration-training': '/collaboration-training.html',
      '/negotiation-training': '/negotiation-training.html',
      '/psychopath-mask-training': '/psychopath-mask-training.html',
      '/persuasion-training': '/persuasion-training.html',
      '/human-nature-training': '/human-nature-training.html',
      '/courage-disliked-training': '/courage-disliked-training.html',
      '/power-literacy-training': '/power-literacy-training.html',
      '/communication-colors-training': '/communication-colors-training.html',
      '/psychopath-protection-training': '/psychopath-protection-training.html',
      '/narcissist-boundaries-training': '/narcissist-boundaries-training.html',
      '/self-sabotage-training': '/self-sabotage-training.html',
      '/influence-science-training': '/influence-science-training.html',
