(() => {
  ...
  const cues = () => [
    {at: duration() * 0.0, title: "Make yourself at home.", text: "Welcome to Sucha Wellness Yoga Nidra. Make yourself comfortable. Let the ground hold you. For a little while, there is nothing you need to do. Choose a position you can rest in comfortably. Let the surface beneath you carry your weight. Your eyes may close, or stay softly open. For these few minutes, you have permission to do less."},
    {at: duration() * 0.105131, title: "An easy beginning.", text: "If it feels pleasant, breathe in gently, add a small second sip of air, then release one slow, easy sigh. There is no need to fill the lungs. You can simply keep your ordinary breath instead."},
    {at: duration() * 0.181322, title: "Arrive in this room.", text: "Let breathing return to its own rhythm. Notice a sound nearby, and perhaps a sound farther away. Feel where your body meets the mat or bed. You are here, supported, with room to settle."},
    {at: duration() * 0.263036, title: "Soften around the face.", text: "Bring a little attention to your forehead. Let the space around your eyes be easy. Notice your cheeks, your jaw, and your tongue resting in the mouth. Nothing needs to be held tightly."},
    {at: duration() * 0.334608, title: "The right arm.", text: "Notice your right shoulder, your upper arm, and your elbow. Let attention travel down to the wrist, the palm, and each finger. You do not need to move. Simply notice this hand resting."},
    {at: duration() * 0.414675, title: "The left arm.", text: "Now notice your left shoulder and arm. Your elbow, your wrist, the palm of your hand, and your fingers. Allow this side to feel supported too. Any sensation, or very little sensation, is welcome."},
    {at: duration() * 0.519418, title: "The centre of the body.", text: "Notice your back where it touches the surface below. Feel the chest and belly moving in their own quiet way. Let awareness reach the waist, the hips, and the weight of the pelvis."},
    {at: duration() * 0.585919, title: "The right leg.", text: "Let attention move into your right thigh, your knee, and your lower leg. Notice the ankle, the heel, the sole of the foot, and the toes. Let the whole leg rest without effort."},
    {at: duration() * 0.665469, title: "The left leg.", text: "Notice your left thigh and knee. The lower leg, the ankle, the heel, and the foot. Feel the toes at rest. There is no need to make both sides feel the same."},
    {at: duration() * 0.742015, title: "Rest as a whole.", text: "Allow awareness to include the whole body, from the head to the feet. Let the separate places become one resting body. Thoughts may come and go. You can return to the simple feeling of being supported."},
    {at: duration() * 0.830217, title: "Let the breath pass.", text: "If you like, count each complete, natural breath backwards from ten. One number for a breath in and out. There is no set speed. If counting feels like work, leave it aside and rest."},
    {at: duration() * 0.931271, title: "Welcome the room again.", text: "Let go of counting. Notice the sounds around you and the support beneath you. Invite a little movement into your fingers and toes. Open your eyes when you are ready. There is no hurry to get up."}
  ];
  function silence() {
  ...
  function speak(cue) {
    ...
    narration.src = `/assets/yoga-nidra-voice-soft/${file}.mp3`;
    narration.playbackRate = 0.6;
